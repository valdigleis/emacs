...
* Configuração para verificação de sintaxe e servidores de linguagens
...
** LSP Mode
Atualmente está configurado para as linguagens HTML, CSS, PHP, C e C++, porém, no caso de C/C++ é necessário instalar o [[https://clangd.llvm.org/][clangd]] esteja instalado no seu sistema.
#+begin_src emacs-lisp
