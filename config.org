...
** Java
É necessáro o [[https://openjdk.org/][OpenJDK]] e [[https://maven.apache.org/][maven]] estejam instalados no seu sistema, e disponíveis via PATH, o [[https://projects.eclipse.org/projects/eclipse.jdt.ls][JDT LS]] será instalado automaticamente pelo =lsp-java= na primeira execução do =java-mode= no Emacs.
#+begin_src emacs-lisp
